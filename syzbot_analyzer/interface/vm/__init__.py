...
class VM(VMInstance, VMState):
    def __init__(self, linux, port, image, arch='amd64', proj_path='/tmp/', mem="2G", cpu="2", key=None, gdb_port=None, opts=None, log_name='vm.log', debug=False):
        ...
        if gdb_port != None:
            VMState.__init__(self, linux, gdb_port, arch)