...
class VM(VMInstance, VMState):
    def __init__(self, linux, port, image, arch='amd64', proj_path='/tmp/', mem="2G", cpu="2", key=None, gdb_port=None, mon_port=None, opts=None, log_name='vm.log', log_suffix="", hash_tag=None, timeout=None, debug=False, logger=None):
