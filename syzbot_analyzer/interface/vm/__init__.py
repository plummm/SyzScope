...
class VM(VMInstance, VMState):
    def __init__(self, linux, port, image, arch='amd64', proj_path='/tmp/', mem="2G", cpu="2", key=None, gdb_port=None, mon_port=None, opts=None, log_name='vm.log', timeout=None, debug=False, logger=None):
        VMInstance.__init__(self, proj_path=proj_path, log_name=log_name, logger=logger, debug=debug)
